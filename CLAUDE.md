...
- `cinnamon-platform/` — Java 17 / Spring Boot 4.1.1 backend (Maven submodule), plus `cinnamon-frontend/` (Angular 20 + Angular Material) embedded as a static resource via `frontend-maven-plugin`
