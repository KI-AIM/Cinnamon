...
def build_non_text_repair_prompt_prefix(
    *,
    ...
    return (
        ...
        "- impossible or illogical date/order relations.\n" \
        "- boolean inconsistencies.\n" \
        "- other implausible combinations of structured values.\n"
        "Row repair rules:\n"
        "Fix clearly derived or calculated fields.\n"
...
def build_text_enrichment_prompt_prefix(
    *,
    ...
    return (
        ...
        "- Treat the repaired non-TEXT fields as ground truth for this row.\n"
        ...
        "- The most similar neighboring reference row is the strongest semantic reference.\n"
        "- Additional neighboring reference rows are weaker references for structure, style, and variation.\n"
        "- Use the structured context of the reference rows to understand why their TEXT is plausible.\n"
        "- The closest reference row is not the target. It is only inspiration.\n"
