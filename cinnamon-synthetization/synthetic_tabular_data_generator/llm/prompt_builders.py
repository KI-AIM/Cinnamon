...
def build_tabular_text_completion_prompt_prefix(
    *,
    ...
    return (
        ...
        "- Every non-missing structured fact must appear explicitly in the generated TEXT with its exact value, even if it is not typically mentioned.\n"
        "- Do not omit, generalize or replace any structured fact. Additional reference information absent from the structured schema may be included if consistent with every ground-truth fact.\n"
