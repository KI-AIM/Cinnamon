...
class LlmNearestNeighborKnowledgeGroundedTextSynthesisSynthesizer(TabularDataSynthesizer):
    def __init__(
        self,
    ...
    def _not_implemented() -> None:
        raise NotImplementedError(
            "The synthesizer 'llm_nearest_neighbor_knowledge_grounded_text_synthesis' is registered but not implemented yet."
        )
